    ...
    public class MockService : IMockService
    {
        ...
        private void InitTweets()
        {
            Tweets = new List<TweetModel>
            {
                ...
                //    Id = 3,
                //    UserId = 3,
                //    Text = "123 #NoNuanceNovember um quisquam eius #AMAs sed odit fugiat iusto fuga #blockchain praesentium optio, eaque rerum! Provident similique accusantium nemo autem. molestias architecto voluptate aliquam",
                ...
                //    Id = 2,
                //    UserId = 2,
                //    Text = "#amas masd #amas masd #amas masd #amas masd #amas masd #amas masd #amas masd #amas masd #amas masd #amas masd #amas masd",
                //    Media = Enums.EAttachedMediaType.Gif,
                //    MediaPaths = new List<string>
                //    {
                //        "https://thumbs.gfycat.com/PaltryWickedCrayfish-max-1mb.gif",
